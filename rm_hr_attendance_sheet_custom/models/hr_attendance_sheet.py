        ...
        for rec in self:
            if rec.contract_id:
                ...
                overtime = [{
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'ov')) / rec.contract_id.resource_calendar_id.hours_per_day or 1, #rec.tot_overtime
                }]
                absence = [{
                    'name': "Absence",
                    'code': 'ABS',
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'ab')) / rec.contract_id.resource_calendar_id.hours_per_day or 1, # rec.tot_absence
                }]
                late = [{
                    'name': "Late In",
                    'code': 'LATE',
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'late')) / rec.contract_id.resource_calendar_id.hours_per_day or 1, #self.tot_late
                }]
                ...
                difftime = [{
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'diff')) / rec.contract_id.resource_calendar_id.hours_per_day or 1, #self.tot_difftime
                }]
                miss_punch = [{
                    'name': "Miss Punch",
                    'code': 'ATTMISS',
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'mis')) / rec.contract_id.resource_calendar_id.hours_per_day or 1, #self.tot_difftime
                }]
