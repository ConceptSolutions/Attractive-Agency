...
class BiomtericDeviceInfo(models.Model):
    ...
    def test_connection_device(self):
        ...
        zk = ZK(self.ipaddress, int(self.portnumber), password=password , timeout=500)
    ...
    def download_attendance_oldapi(self):
        ...
        if self.protocol == 'udp':
            force_udp = True
        zk = ZK(self.ipaddress, port=int(self.portnumber), timeout=500, password=password, force_udp=False, ommit_ping=False)
